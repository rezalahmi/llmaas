...
# def format_response_delta(request_id: str, model: str, content: str):
#     return (
...
# def format_response_completed(request_id: str, model: str):
#     return (
