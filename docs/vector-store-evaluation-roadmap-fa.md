...
> **وضعیت سند: تاریخی / جایگزین‌شده**
>
> این سند طرح پژوهشی اولیه است و دیگر مرجع ترتیب اجرا یا تعیین محدوده MVP نیست.
> مرجع رسمی و به‌روز پروژه از تاریخ ۱۴۰۵/۰۵/۰۵:
> [`llmaas-client-aligned-delivery-roadmap-fa.md`](./llmaas-client-aligned-delivery-roadmap-fa.md)
>
> در صورت تعارض، سند جدید اولویت دارد. این فایل فقط برای حفظ سابقه تصمیم‌ها
> و جزئیات پژوهشی نگهداری می‌شود.
